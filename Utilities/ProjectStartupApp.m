classdef ProjectStartupApp < matlab.apps.AppBase
    ...
    properties (Access = private)
        ...
        GitHubRepository = "Transfer-Function-Analysis-of-Dynamic-Systems";
    end
...
%}
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.WelcomeTitle.Text = 'Welcome to Transfer Function Analysis of Dynamic Systems';
            ...
            app.ReviewTitle.Text = 'Welcome to Transfer Function Analysis of Dynamic Systems';
